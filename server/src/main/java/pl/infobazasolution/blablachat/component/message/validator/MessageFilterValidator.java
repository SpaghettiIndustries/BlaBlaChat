...
public class MessageFilterValidator {
    ...
    public Boolean validate(Integer userId, MessageFilter filter) throws ValidationException {
        ...
        if (!ValidationUtils.userBelongsToTopic(userId, filter.getTopicId(), topicDao))
